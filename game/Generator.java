    ...
    public void run() {
        while (Game.INSTANCE.running) {
            ...
            if (chairUpgrade.getCurrentLevel() != 0) {
                DestroyableEntity chair = new DestroyableEntity(randomPos.getX(), randomPos.getY(), chairUpgrade.getIcon(), ChairLevel.values()[(int) chairUpgrade.getCurrentLevel()].cash);
